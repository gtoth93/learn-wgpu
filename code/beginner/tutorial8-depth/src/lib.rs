...
use wgpu::{
    ...
    PipelineCompilationOptions, PipelineLayoutDescriptor, PolygonMode, PowerPreference, PrimitiveState,
    PrimitiveTopology, Queue, RenderPassColorAttachment, RenderPassDepthStencilAttachment,
    RenderPassDescriptor, RenderPipeline, RenderPipelineDescriptor, RequestAdapterOptions,
    SamplerBindingType, ShaderStages, StencilState, StoreOp, Surface, SurfaceConfiguration,
...
impl State {
    ...
    async fn new(window: Arc<Window>) -> State {
        ...
        let render_pipeline_desc = RenderPipelineDescriptor {
            ...
            depth_stencil: Some(depth_stencil_state), // UPDATED!
    ...
    fn render(&mut self) -> Result<(), SurfaceError> {
...

        {
            ...
            let render_pass_desc = RenderPassDescriptor {
                ...
                depth_stencil_attachment: Some(depth_stencil_attachment), // UPDATED!
