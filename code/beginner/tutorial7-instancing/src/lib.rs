...
use wgpu::{
    ...
    BufferAddress, BufferBindingType, BufferUsages, Color, ColorTargetState,
    ColorWrites, CommandEncoderDescriptor, Device, DeviceDescriptor, Face, Features, FragmentState,
    FrontFace, IndexFormat, InstanceDescriptor, Limits, LoadOp, MemoryHints, MultisampleState,
...
impl State {
    ...
    async fn new(window: Arc<Window>) -> State {
        ...
        let instances = (0..NUM_INSTANCES_PER_ROW)
            .flat_map(|z| {
                let instance_fn = move |x| {
                    let position =
                        Vec3A::new(f32::from(x), 0.0, f32::from(z)) - INSTANCE_DISPLACEMENT;
        ...
        let render_pipeline_desc = RenderPipelineDescriptor {
            ...
            vertex: VertexState {
                ...
                buffers: &[Vertex::desc(), InstanceRaw::desc()], // UPDATED!
                compilation_options: PipelineCompilationOptions::default(),
            },
    ...
    fn render(&mut self) -> Result<(), SurfaceError> {
...

        {
            ...
            render_pass.set_vertex_buffer(1, self.instance_buffer.slice(..)); // NEW!
