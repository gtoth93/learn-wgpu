...
impl CameraUniform {
    ...
    fn update_view_proj(&mut self, camera: &Camera) {
        ...
        self.view_position = camera.eye.extend(1.0); // NEW!
    ...
    fn to_raw(&self) -> InstanceRaw {
        InstanceRaw {
            model: Mat4::from_rotation_translation(self.rotation, self.position.into())
                .to_cols_array_2d(),
            normal: Mat3::from_quat(self.rotation).to_cols_array_2d(), // NEW!
        }
    }
}
...
impl InstanceRaw {
    ...
    const ATTRIBS: [VertexAttribute; 7] = wgpu::vertex_attr_array![
        5 => Float32x4,
        6 => Float32x4,
        7 => Float32x4,
        8 => Float32x4,
...
impl State {
    ...
    async fn new(window: Arc<Window>) -> State {
        ...
        let camera_bind_group_layout_entry = BindGroupLayoutEntry {
            binding: 0,
            visibility: ShaderStages::VERTEX | ShaderStages::FRAGMENT, // UPDATED!
        ...
        let pipeline_layout_desc = PipelineLayoutDescriptor {
            ...
            bind_group_layouts: &[
                ...
                &light_bind_group_layout, // UPDATED!
            ],
    ...
    fn render(&mut self) -> Result<(), SurfaceError> {
...

        {
            ...
            render_pass.set_pipeline(&self.light_render_pipeline); // UPDATED!
